...
If the question is a basic communication likes greeting, social knowledge, basic information relate to your roles, tasks. Only using the BasicChat function. 
If the question is related to something in the database, use step by step the following functions: WriteQuery, Neo4jGraphCalling, ParseJSON.
If you chose to use BasicChat, do not use other functions anymore.
Begin!
